...
_accept:
  ; accept arguments
  push byte 0  ; push 0 decimal onto stack (address length argument), NULL - we don't need to know anything about the client
  push byte 0  ; push 0 decimal onto stack (address argument), NULL - we don't need to know anything about the client
  push edi     ; push the file descriptor onto stack (socket fd)

  mov ecx, esp ; move address of arguments into ecx (ptr to argument array)

  mov ebx, 5   ; invoke subroutine ACCEPT (sys_accept 5)
  mov eax, 102 ; invoke SYS_SOCKETCALL (kernel opcode 102)
